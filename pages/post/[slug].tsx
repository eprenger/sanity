    ...
    <main>
            ...
            <div className="pt-10">
                ...
                className=""
                 ...
                 serializers={{
                    ...
                    h2: (props: any) => (
                        <h1 className="text-x1 font-bold my-5" {...props} />
                    ),
                    li: ({ children }: any) => (
        ...
        {submitted ? (
            ...
            <label className="block mb-5">
                ...
                ring-yellow-500 outline-none focus:ring" placeholder="John Doe" type="text" />
            </label>
            <label className="block mb-5">
                ...
                className="shadow border rounded py-2 px-3 form-input mt-1 block w-full 
                ring-yellow-500 outline-none focus:ring" placeholder="name@domain.com" type="email" />
            </label>
            <label className="block mb-5">
                ...
                ring-yellow-500 outline-none focus:ring" placeholder="Leave us a comment!" rows={8} />
            </label>
                ...
                <input type="submit" value="Submit" className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline 
...
export const getStaticProps: GetStaticProps = async ({params}) => {
    ...
    *[_type == "post" && slug.current == $slug][0]{
    ...
    return {
        ...
        revalidate: 600, //after 600 seconds will update old cached version
    };
};